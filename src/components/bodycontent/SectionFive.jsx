    ...
    >
      ...
      {showButton && (
        <button
          ...
          className={
            insideSection
              ? "absolute right-2 lg:right-16 bottom-6  sm:bottom-4 z-10 bg-gray-700/70 hover:bg-gray-600/90 font-semibold text-black rounded w-35 h-12 shadow flex items-center justify-center"
              : "fixed right-2 lg:right-16 bottom-6 lg:bottom-4 z-50 bg-gray-700/70 hover:bg-gray-600/90 font-semibold text-black rounded w-35 h-12 shadow flex items-center justify-center"
          }
        >
          Back to top
          <svg
